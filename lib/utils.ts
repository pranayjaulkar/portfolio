...
export const PROJECTS = [
	...
	},
	{
		...
		isNew: false,
		description:
			"Movies App is a full-stack CRUD application that enables users to add, update, and manage movie collections while also fetching real movie data via the Streaming Availability API. It is a simple CRUD application I developed to explore and learn Angular.",
		image: "/movies.jpg",
		inDevelopment: false,
		technologies: [
			"Angular",
		...
		githubUrl: "https://github.com/pranayjaulkar/movies-app",
		projectUrl: "https://movies-app-zkh5.onrender.com",
	},
	{
		title: "Yelpcamp",
		isNew: false,
		description:
			"Yelpcamp is a social media website for campers where they can share their favorite camping places and interact with others. Yelpcamp is fully server side rendered web application developed with EJS for HTML templating and Express.js for handling HTTP requests. It incorporates Cloudinary for media management and has emebedded Maps using Mapbox, geolocation and JWT for authentication.",
