...
export default function ColumnCard({
	...
	return (
		<div
			ref={ref}
			className={`max-w-[1000px] md:h-[400px] lg:h-[350px] overflow-hidden border border-gray-700 flex flex-col md:flex-row items-center transition-all duration-1000 ${
				inView
		...
		>
			...
			<div className="w-full h-full flex-1 p-4 md:pl-10 flex flex-col text-white bg-slate-900 space-y-4">
				{/* Title */}
				...
				{/* Description */}
				<p className="break-words text-zinc-300 text-xs leading-5 mb-auto">
					{description}
				</p>
				...
				<div className="flex flex-wrap space-x-2">
					{technologies.map((technology, i) => (
						<div className="py-1.5">
							<span className="text-xs border px-3 py-1 border-gray-700 text-secondary">
								{technology}
							</span>
						</div>
					))}
