...
export const AboutSection: React.FC<AboutSectionProps> = () => {
  return (
    <div className="h-[450px]">
      <div
        className=" h-full bg-primary flex justify-center items-center"
       
      >
        <div className=" m-auto top-0 bottom-0 left-0 right-0 flex justify-center flex-col items-center animate-none p-8">
          <h3 className="text-white text-xl md:text-2xl lg:text-3xl  animation-none font-anton scale-x-110 tracking-wider ">
            Hi, I&apos;m Pranay. Nice to meet you
          </h3>
          <p className="text-white text-sm md:text-md lg:text-xl mt-8 max-w-[47rem] text-center animate-none ">
